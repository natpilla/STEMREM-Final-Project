...
```{r}
#load non-normalized seurat objects..should I do with these already normalized...NO: https://www.bioconductor.org/packages/release/bioc/vignettes/DESeq2/inst/doc/DESeq2.html#standard-workflow
#should I merge the seurat objects?
